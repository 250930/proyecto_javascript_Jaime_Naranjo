  ...
  productModalContent.innerHTML = `
    <form id="productForm" class="modal-form product-form" novalidate>
      ...
      <div class="product-form-fields">
        ...
        <div class="field-group">
          <label for="productImage">Nombre de imagen</label>
          <input id="productImage" name="image" type="text"
            value="${product ? product.image.replace("images/", "") : ""}"
              placeholder="chaqueta.png">
        </div>
...
function handleSubmit(existing) {
  ...
  const image = `images/${fd.get("image").trim()}`;
